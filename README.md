...
| [Выявление профилей потребления](https://github.com/mariam1298/DA_project/tree/main/E-comm_project) | Анализ покупок и сегментация товаров на основе принадлежности к той или иной товарной категории, выявление статестической разницы между категориями| *Pandas, plotly.express, pymystem3, scipy* |
